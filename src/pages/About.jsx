...
const milestones = [
  ...
  { year: '2025', event: 'Surpassed 20 lakh daily viewers — became one of Karnataka\'s most-watched local channels.' },
          ...
          <div ref={containerRef} className="flex flex-col lg:flex-row gap-16 lg:gap-20 items-center">
            ...
            <ScrollReveal direction="right" className="w-full lg:w-7/12">
              <div className="space-y-5 lg:py-6">
                <div>
                  <h3 className="font-heading font-bold text-2xl sm:text-3xl text-white/95 mb-1">
                ...
                <div className="space-y-4 text-white/60 leading-relaxed text-sm sm:text-base">
                  <p>
                    ...
                    our founder established Media TV as a small local channel in Mysore. Today, it has grown to become
                  ...
                  <p>
                    ...
                    programs, empowering local businesses through affordable advertising, and giving a platform to

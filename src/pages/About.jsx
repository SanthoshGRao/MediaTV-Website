    ...
    <div>
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <span className="text-brand-400 font-accent text-xs tracking-[4px] uppercase mb-3 block">Our Story</span>
          <h1 className="section-title text-4xl sm:text-5xl gradient-text">About Media TV</h1>
          <div className="gold-divider mx-auto" />
          <p className="section-subtitle mx-auto mt-6 text-base sm:text-lg">
      ...
      <section className="py-20 bg-gradient-section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((v, i) => (
              <ScrollReveal key={v.title} delay={Math.min(i * 0.1, 0.3)}>
      ...
      <section className="py-20 bg-gradient-dark">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            {milestones.map((m, i) => (
              <ScrollReveal key={m.year} delay={Math.min(i * 0.1, 0.4)}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4">
            {coverageAreas.map((area, i) => (
              <ScrollReveal key={area.area} delay={Math.min(i * 0.03, 0.3)}>
